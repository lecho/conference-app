...
public class Agenda {
    ...
    public static List<AgendaItem> fromJson(String json) {
        ...
        for (Map.Entry<String, AgendaItem> entry : objectsMap.entrySet()) {
            entry.getValue().slotKey = entry.getKey();
        }

        List<AgendaItem> objects = new ArrayList<>(objectsMap.size());
        objects.addAll(objectsMap.values());
        return objects;
    }
