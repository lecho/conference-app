...
public class AgendaItemApiDto {
    ...
    public static class AgendaItemApiParser extends BaseApiParser<AgendaItemApiDto> {

        @Override
        public Map<String, AgendaItemApiDto> fromJson(String json) {
            Type type = new TypeToken<Map<String, AgendaItemApiDto>>() {
            }.getType();
            Gson gson = new GsonBuilder().setFieldNamingPolicy(FieldNamingPolicy.LOWER_CASE_WITH_UNDERSCORES)
                    .registerTypeAdapter(AgendaItemApiDto.class, new AgendaItemDeserializer()).create();
            Map<String, AgendaItemApiDto> objectsMap = gson.fromJson(json, type);
            return objectsMap;
        }
    }
    ...
    private static class AgendaItemDeserializer implements JsonDeserializer<AgendaItemApiDto> {
        ...
        public AgendaItemApiDto deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws
            ...
            if (!(json instanceof JsonObject)) {
                throw new IllegalStateException("Could not deserialize AgendaItemApiDto, JsonElement is not instance " +
                        "of JsonObject");
            }
